(function (global) {
  ...
  const PROFILES = [
    ...
    ["cascavel", "popular_name", /\bcascavel|cascaveis\b/, "Cascavel é um nome popular associado principalmente a serpentes do gênero Crotalus. No Brasil, Crotalus durissus é uma referência importante, mas o nome popular não deve ser convertido automaticamente em uma identificação fechada sem localidade e características diagnósticas. Cascavéis são serpentes peçonhentas e predadoras, com papel ecológico no controle de pequenos vertebrados. A biblioteca científica local contém materiais sobre Crotalus durissus, distribuição, história natural e acidentes ofídicos. Segurança: observe à distância, não tente capturar ou matar e, em caso de picada, procure atendimento médico imediatamente; não faça torniquete, cortes ou aplicações caseiras."],
    ...
    ["crotalus", "genus", /\bcrotalus\b/, "Crotalus é um gênero de serpentes peçonhentas da família Viperidae, associado às cascavéis. No Brasil, Crotalus durissus é uma referência importante. O gênero possui relevância ecológica como predador e relevância médica por seus acidentes ofídicos. A identificação e a distribuição precisam ser avaliadas com fonte, localidade e evidência adequadas."],
