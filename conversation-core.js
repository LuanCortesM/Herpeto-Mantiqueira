(function (global) {
  ...
  function classifyConversationIntent(text, options = {}) {
    ...
    const methodology = /\b(invent[aá]rio|levantamento|metodolog|metodologias|amostragem|pitfall|busca ativa|esfor[cç]o amostral|artigo|vi[eé]s|curva de acumula[cç][aã]o|ficha de campo|dados m[ií]nimos|observa[cç][aã]o cient[ií]fica|procura visual|encontros ocasionais|grava[cç][aã]o ac[uú]stica|edna|dna ambiental)\b/.test(q);
